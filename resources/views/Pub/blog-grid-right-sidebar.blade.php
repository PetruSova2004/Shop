                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-3 col">
                            <div class="header-logo">
                                <a href="index.blade.php"><img src="assets/images/logo/logo.png" alt="Site Logo" /></a>
                            </div>
                        </div>
                    ...
                    <div class="header-nav">
                        <div class="main-menu position-relative">
                            <ul>
                                ...
                                <li class="dropdown position-static"><a href="about.blade.php">Pages <i class="fa fa-angle-down"></i></a>
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-flex align-items-center p-0 border-0 flex-column justify-content-center">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.blade.php"><img class="img-responsive w-100" src="assets/images/banner/menu-banner.png" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="mega-menu d-block">
                                        <li class="d-flex">
                                            ...
                                            <ul class="d-block">
                                                ...
                                                <li><a href="single-product-gallery-right.blade.php">Product Gallery Right</a> </li>
                                ...
                                <li class="dropdown "><a href="#">Blog <i class="fa fa-angle-down"></i></a>
                                    <ul class="sub-menu">
                                        <li class="dropdown position-static"><a href="blog-grid-left-sidebar.blade.php">Blog Grid
                                        ...
                                        <li class="dropdown position-static"><a href="blog-list-left-sidebar.blade.php">Blog List
                                                <i class="fa fa-angle-right"></i></a>
                                            <ul class="sub-menu sub-menu-2">
            ...
            <div class="inner">
                ...
                <div class="body customScroll">
                    <ul class="minicart-product-list">
                        <li>
                            <a href="single-product.blade.php" class="image"><img src="assets/images/product-image/1.webp" alt="Cart product Image"></a>
                            <div class="content">
                        ...
                        <li>
                            <a href="single-product.blade.php" class="image"><img src="assets/images/product-image/2.webp" alt="Cart product Image"></a>
                            <div class="content">
                        ...
                        <li>
                            <a href="single-product.blade.php" class="image"><img src="assets/images/product-image/3.webp" alt="Cart product Image"></a>
                            <div class="content">
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog">
                                    <div class="blog-image">
                                        <a href="blog-single-left-sidebar.blade.php"><img src="assets/images/blog-image/3.webp" class="img-responsive w-100" alt=""></a>
                                    </div>
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i> Wild Nick</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">The Pros and Cons of Smart Product</a></h5>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog ">
                                    <div class="blog-image">
                                        <a href="blog-single-left-sidebar.blade.php"><img src="assets/images/blog-image/4.webp" class="img-responsive w-100" alt=""></a>
                                    </div>
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i> Oaklee Odom</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">20 Insightful Quotes About Smart Product</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i> Oslad Den</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">12 coz You Shouldn't Invest in Smart Product</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog ">
                                    ...
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i>Odrl sala</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">The Biggest Problem With Smart Product</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i> Awesom Suk</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">20 Fabulous Infographics About Smart Product</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i> Dom Aokle</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">This Week's Top Stories About Smart Product</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog">
                                    ...
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i>Tanvir Boss</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">The 13 Best Pinterest Boards for Smart Product</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-50px">
                                <div class="single-blog">
                                    <div class="blog-image">
                                        <a href="blog-single-left-sidebar.blade.php"><img src="assets/images/blog-image/5.webp" class="img-responsive w-100" alt=""></a>
                                    </div>
                                    <div class="blog-text">
                                        <div class="blog-athor-date line-height-1">
                                            <span class="blog-date"><i class="fa fa-calendar" aria-hidden="true"></i> 27,Jun 2030</span>
                                            <span><a class="blog-author" href="blog-grid.blade.php"><i class="fa fa-user" aria-hidden="true"></i> Omite Andle</a></span>
                                        </div>
                                        <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php"> Books About Smart Product You Should Read</a></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incid ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                        <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="recent-post-widget">
                                        <div class="recent-single-post d-flex">
                                            <div class="thumb-side">
                                                <a href="blog-single-left-sidebar.blade.php"><img src="assets/images/blog-image/post-1.webp" alt="" /></a>
                                            </div>
                                            <div class="media-side">
                                                <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i>27  jun, 2022</span>
                                                <h5><a href="blog-single-left-sidebar.blade.php">Lorem ipsum dolorl
                                                        amet conse adip</a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="recent-single-post d-flex">
                                            <div class="thumb-side">
                                                <a href="blog-single-left-sidebar.blade.php"><img src="assets/images/blog-image/post-2.webp" alt="" /></a>
                                            </div>
                                            <div class="media-side">
                                                <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i>27  jun, 2022</span>
                                                <h5><a href="blog-single-left-sidebar.blade.php">Lorem ipsum dolorl
                                        ...
                                        <div class="recent-single-post d-flex">
                                            <div class="thumb-side">
                                                <a href="blog-single-left-sidebar.blade.php"><img src="assets/images/blog-image/post-3.webp" alt="" /></a>
                                            </div>
                                            <div class="media-side">
                                                <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i>27  jun, 2022</span>
                                                <h5><a href="blog-single-left-sidebar.blade.php">Lorem ipsum dolorl
                            ...
                            <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                                <div class="single-wedge">
                                    <div class="footer-logo">
                                        <a href="index.blade.php"><img src="assets/images/logo/footer-logo.png" alt=""></a>
                                    </div>
                                    ...
                                    <div class="footer-links">
                                        <div class="footer-row">
                                            <ul class="align-items-center">
                                                <li class="li"><a class="single-link" href="my-account.blade.php">My Account</a></li>
                                                <li class="li"><a class="single-link" href="contact.blade.php">Contact</a></li>
                                                <li class="li"><a class="single-link" href="cart.blade.php">Shopping cart</a></li>
                                                <li class="li"><a class="single-link" href="shop-left-sidebar.blade.php">Shop</a></li>
                                                <li class="li"><a class="single-link" href="login.blade.php">Services Login</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
