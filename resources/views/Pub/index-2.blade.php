                            ...
                            <div class="row h-100 flex-row-reverse">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 align-self-center sm-center-view">
                                    <div class="hero-slide-content hero-slide-content-2 slider-animated-1">
                                        ...
                                        <a href="shop-left-sidebar.blade.php" class="btn btn-primary text-capitalize">Shop All Devices</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="single-banner nth-child-2 mb-lm-30px">
                            ...
                            <div class="banner-content nth-child-3">
                                ...
                                <a href="shop-left-sidebar.blade.php" class="shop-link">Shop Now <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container h-100">
                <div class="row justify-content-center align-items-center h-100">
                    <div class="col-12 text-center">
                        ...
                        <a href="shop-left-sidebar.blade.php" class="btn btn-primary text-capitalize m-auto">Shop All Devices</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-6 col-sm-6 mb-xs-30px">
                        <div class="single-blog">
                            ...
                            <div class="blog-text">
                                ...
                                <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">10 Quick Tips About Smart Product</a></h5>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="single-blog">
                            ...
                            <div class="blog-text">
                                ...
                                <h5 class="blog-heading"><a class="blog-heading-link" href="blog-single-left-sidebar.blade.php">5 Real-Life Lessons About Smart Product</a></h5>
                                <p>Lorem ipsum dolor sit amet consl adipisi elit, sed do eiusmod templ incididunt ut labore</p>
                                <a href="blog-single-left-sidebar.blade.php" class="btn btn-primary blog-btn"> Read More</a>
                            </div>
                        </div>
